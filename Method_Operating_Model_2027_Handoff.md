...
**File:** `Method_Operating_Model_2027_33.xlsx` (26 tabs, 0 formula errors, recalculated via LibreOffice)
...
(v33: NA Beverage fully ungrouped on `LW Item Forecast` — all 82 items listed individually (no "All other" remainder); other categories keep top-N + remainder.)
